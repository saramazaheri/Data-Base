...
<html lang="en">
  <head>
    ...
    <title>Let's Talk | New Counsultant</title>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h4 class="m-0">Feel Like Talking? <small>We Are There For You</small></h1>
              </div>
              <!-- /.col -->
              <div class="col-sm-6">
              ...
              <div class="card">
                <div class="card-body login-card-body">
                  <p class="login-box-msg">
                    Type your E-mail to be contacted to
                  </p>

                  <form action="consultantMailSub.html" method="post">
