...
<html lang="en">
  <head>
    ...
    <title>Let's Talk | Consultee Login</title>
        ...
        <div class="content">
          ...
          <div class="card">
            <div class="card-body login-card-body">
              ...
              <form action="registration/consulteelogin.php" method="post">
                ...
                <div class="row">
                  ...
                  <!-- /.col -->
                        ...
                        <p class="mb-1">
                    <a href="consultee-forgot-password.html">I forgot my password</a>
                  </p>
                  <p class="mb-0">
                    <a href="ConsulteeRegister.html" class="text-center"
