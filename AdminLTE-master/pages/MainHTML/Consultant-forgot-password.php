...
<html lang="en">
  ...
  <body class="hold-transition layout-top-nav">
    <div class="wrapper">
      ...
      <form action="Consultant-recover-pw.html" method="post">
      ...
      <p class="mt-3 mb-1">
        <a href="ConsultantLogin.html">Login</a>
      </p>
      <p class="mb-0">
        <a href="ConsultantRegister.html" class="text-center"
          >If you want to be one of us click here</a
        >
      </p>
    </div>
    <!-- /.login-card-body -->
