...
<html lang="en">
  <head>
    ...
    <title>Let's Talk | Consultant Panel</title>
          ...
          <!-- /.col -->
                ...
                <div class="row">
                  <div class="col-sm-4 border-right">
                    <div class="description-block">
                      <span class="description-header">Case Numbers</span>
                  ...
                  <div class="col-sm-4 border-right">
                    <div class="description-block">
                      <span class="description-header">Salary</span>
                  ...
                  <div class="col-sm-4">
                    <div class="description-block">
                      <span class="description-header">Remaining Cases</span>
            ...
            <div class="card container">
              <div class="card-header">
                <h3 class="card-title">My Consultees Informations</h3>
                ...
                <table class="table table-hover text-nowrap" >
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>11-16-1999</td>
                      <td>22</td>
                      <td><span class="tag tag-warning">Male</span></td>
                      <td>Bacon ipsum dolor sit amet salami venison chicken flank fatback doner.</td>
                    </tr>
                    <tr>
                      <td>Sara Mazaheri</td>
                      <td>11-20-2001</td>
                      <td>21</td>
                      <td><span class="tag tag-primary">Female</span></td>
                      <td>Bacon ipsum dolor sit amet salami venison chicken flank fatback doner.</td>
                    </tr>
                    <tr>
                      <td>Minoo Roosta</td>
                      <td>01-27-2000</td>
                      <td>21</td>
                      <td><span class="tag tag-danger">Female</span></td>
                      <td>Bacon ipsum dolor sit amet salami venison chicken flank fatback doner.</td>
                    </tr>
                  </tbody>
                </table>
